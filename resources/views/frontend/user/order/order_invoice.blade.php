  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>Amkasugu</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
                Amkasugu Head Office
               Email:devkind@gmail.com <br>
               Mob: 1245454545 <br>
               Bamako 1207,Grand marché:#4 <br>
        ...
        <td>
          <p class="font">
            ...
            Order Date: {{ $order->order_date }} <br>
             Delivery Date: {{ $order->deliverd_date }} <br>
  ...
  <table width="100%">
   ...
   @foreach ($orderItem as $item)
      ...
      <tr class="font">
        ...
        <td align="center">{{ $item->product->product_name_fr }}</td>
        <td align="center">
          @if($item->size == null)
          ----
          @else
