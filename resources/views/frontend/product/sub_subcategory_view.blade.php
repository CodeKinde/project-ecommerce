              ...
              <div class="sidebar-widget wow fadeInUp">
                ...
                <div class="sidebar-widget-body">
                  <div class="accordion">
                    ...
                    <ul>
                        <li><a href="{{ url('product/subcategory/'.$subcategory->id.'/'.$subcategory->subcategory_slug_fr) }}">
                        @if (session()->get('language') == 'english')
...
<div class="category-product">
    ...
    @endforeach     <!-- /.End foreach product list-container -->
...
<div class="category-product">
    ...
    @endforeach  <!-- /.end foreach list-container -->
