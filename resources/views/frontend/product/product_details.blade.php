            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="info-title control-label">
                         ...
                         <span>*</span></label>
                        @if(session()->get('language') ==  'english')
                        <select class="form-control unicase-form-control selectpicker" style="display: none;" id="color_en">
                        ...
                        @else
                        <select class="form-control unicase-form-control selectpicker" style="display: none;" id="color_fr">
                            <option disabled selected>-- Choisie le couleur--</option>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <span>*</span></label>
                        @if(session()->get('language') ==  'english')
                        <select class="form-control unicase-form-control selectpicker" style="display: none;" id="size_en">
                        ...
                        @else
                        <select class="form-control unicase-form-control selectpicker" style="display: none;" id="size_fr">
                            <option disabled selected>-- Choisie la taille--</option>
                ...
                <div id="review" class="tab-pane">
                 ...
                 $reviews = App\Models\Review::where('product_id',$product->id)->where('status',1)->latest()->limit(5)->get();
                        ...
                        <div class="product-reviews">
                            ...
                            <div class="reviews">
                                ...
                                <div class="review">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <img style="border-radius:50%" src="{{ (!empty($item->user->profile_photo_path)) ? url('upload/user_image/'.$item->user->profile_photo_path): url('upload/no_image.jpg')}}" alt="" width="40px" height="40px"> {{ $item->user->name }}
                                        </div>
                        ...
                        <div class="product-add-review">
                            <h4 class="title">Ecrivez votre propre commentaire</h4>
                            ...
                            <div class="review-form">
                                @guest
                                <p><b>Pour ajouter des commentaire de produit. Vous devez vous connectez en premier <a href="{{ route('login') }}">connectez ici</a></b></p>
                                @else
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control txt" id="exampleInputSummary" name="summary">
                                </div><!-- /.form-group -->
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control txt txt-review" id="exampleInputReview" rows="4"  name="comment"></textarea>
                                </div><!-- /.form-group -->
                            </div>
                        </div><!-- /.row -->
