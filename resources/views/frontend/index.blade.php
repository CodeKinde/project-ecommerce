...
<div class="body-content outer-top-xs" id="top-banner-and-menu">
    ...
    <div class="item">
     ...
     @foreach ($special_offer as $product)
        ...
        @endforeach <!-- /.end foreach special offer -->
 ...
 <!--===================== SPECIAL DEALS======================= -->
    ...
    <div class="sidebar-widget-body outer-top-xs">
        ...
        @foreach ($special_deals as $product)
         ...
         @endforeach <!-- /.end foreach special deals -->
...
<a href="{{ url('product/details/'.$product->id) }}">
    ...
    @endforeach <!-- /.end foreach product -->
     ...
     <h3 class="name"><a href="{{ url('product/details/'.$product->id) }}">
            ...
            <div class="action">
                ...
                <li class="lnk wishlist">
                    <button class="btn btn-primary cart-btn" type="button"><i class="icon fa fa-heart"></i></button>
                 </li>
...
<!-- /.tab-pane -->
          ...
          <section class="section featured-product wow fadeInUp">
            ...
            <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
             @foreach ($featured as $product)
              ...
              @endforeach <!-- /.End foreach featured product -->
              <!-- /.item -->
            </div>
            <!-- /.home-owl-carousel -->
          </section>
          ...
          <section class="section featured-product wow fadeInUp">
            <h3 class="section-title">{{ $skip_category_0->category_name_fr }}</h3>
            <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
             @foreach ($skip_product_0 as $product)
              ...
              @endforeach <!-- /.End skip_category_0  -->
              <!-- /.item -->
            </div>
            <!-- /.home-owl-carousel -->
          </section>
          ...
          <section class="section featured-product wow fadeInUp">
            <h3 class="section-title">{{ $skip_subcategory_0->subcategory_name_fr }}</h3>
            <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
             @foreach ($skip_sproduct_0 as $product)
          ...
          <section class="section featured-product wow fadeInUp">
            <h3 class="section-title">{{ $skip_brand_1->brand_name_fr }}</h3>
            <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
             @foreach ($skip_brand_product_1 as $product)
              ...
              @endforeach <!-- /.End foreach skip_brand product -->
              <!-- /.item -->
            </div>
            <!-- /.home-owl-carousel -->
          </section>
                  ...
                  <div class="blog-post">
                    <div class="blog-post-image">
                      <div class="image"> <a href="blog.html">
                        <img src="{{ asset($post->post_image) }}" alt=""></a> </div>
                    </div>
                    <!-- /.blog-post-image -->

                    <div class="blog-post-info text-left">
                      <h3 class="name"><a href="{{ url('blog/post/details/'.$post->id) }}">
                        @if (session()->get('language') == 'english')
                        {{ $post->title_en }}
                        @else
                        {{ $post->title_fr }}
                      ...
                      <a href="{{ url('blog/post/details/'.$post->id) }}" class="lnk btn btn-primary">Read more</a> </div>
                    <!-- /.blog-post-info -->
