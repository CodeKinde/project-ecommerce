...
<form action="{{ route('coupon.update') }}" method="POST">
       ...
       <div class="row">
            ...
            <div class="form-group">
                ...
                <div class="controls">
            <input id="coupon_name" type="text" name="coupon_name"  class="form-control" value="{{ $coupon->coupon_name}}"></div>
            @error('coupon_name')
            ...
            <div class="form-group">
                ...
                <div class="controls">
            <input id="coupon_discount" type="text" name="coupon_discount"  class="form-control" value="{{ $coupon->coupon_discount}}"></div>
        ...
        <div class="form-group">
            ...
            <div class="controls">
        <input  type="date" name="coupon_validity" id="coupon_validity"  class="form-control" value="{{ $coupon->coupon_validity}}" min="{{ Carbon\Carbon::now()->format('Y-m-d') }}"></div>
