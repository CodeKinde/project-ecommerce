       ...
       <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                <div class="controls">
            <input id="subcategory_name_fr" type="text" name="subcategory_name_fr"  class="form-control" value=""></div>
            ...
            <div class="form-group">
                ...
                <div class="controls">
            <input id="subcategory_name_en" type="text" name="subcategory_name_en"  class="form-control" value=""></div>
